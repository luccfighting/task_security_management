...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            var $operator_icon = $('<div class="flowchart-operator-icon" data-uuid="'+infos.uuid+'"><i class="fa fa-trash" aria-hidden="true" style="margin: 0px 6px;" data-type="delete" title="删除节点"  data-uuid="'+infos.uuid+'"/></i><i class="fa fa-file" aria-hidden="true"  style="margin: 0px 6px;"  data-type="copy" title="复制ID"  data-uuid="'+infos.uuid+'"/></i></div>');
            $operator_icon.appendTo($operator);
